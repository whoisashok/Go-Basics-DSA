...
const file_hello_world_proto_rawDesc = "" +
	"\n" +
	"\x11hello_world.proto\x12\thelloword\"\"\n" +
	...
	"\aGreeter\x12<\n" +
	"\bSayHello\x12\x17.helloword.HelloRequest\x1a\x15.helloword.HelloReply\"\x00\x12A\n" +
	"\rSayHelloAgain\x12\x17.helloword.HelloRequest\x1a\x15.helloword.HelloReply\"\x00B\x06Z\x04./pbb\x06proto3"
...
var file_hello_world_proto_depIdxs = []int32{
	...
	0, // 1: helloword.Greeter.SayHelloAgain:input_type -> helloword.HelloRequest
	1, // 2: helloword.Greeter.SayHello:output_type -> helloword.HelloReply
	1, // 3: helloword.Greeter.SayHelloAgain:output_type -> helloword.HelloReply
